...
@section('content')
    <h2 class="intro-y text-lg font-medium mt-5">Headers</h2>
    @include('admin.header.create')
                    ...
                    <div class="p-5">
                        <div
                            ...
                            <div class="absolute bottom-0 text-white px-5 pb-6 z-10">
                                <a href="" class="block font-medium text-base">{{ $header->title }}</a>
                            </div>
                        </div>
                        <div class="text-slate-600 dark:text-slate-500 mt-5">{{ $header->description }}</div>
                    </div>
                    <div
                      ...
                      <!--  <a class="flex items-center mr-3" href="javascript:;">
                        ...
                        <a href="javascript:;" data-tw-toggle="modal"
                           data-tw-target="#delete-modal-preview-{{$header->id}}"
                           class="flex items-center mr-auto text-danger">
                            <i data-lucide="trash-2" class="px-1 text-danger"></i>
                            Delete</a>
                        <!-- END: Modal Toggle -->
                        <!-- BEGIN: Modal Content -->
                        <div id="delete-modal-preview-{{$header->id}}" class="modal" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body p-0">
                                        ...
                                        <div class="px-5 pb-8 text-center">
                                            <form action="{{ route('admin.header.delete', $header->id) }}"
                                                  method="post">
