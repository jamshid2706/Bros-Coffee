                ...
                <div class="box border-b-2 border-l-2 border-opacity-10 border-black">
                    <div class="p-5">
                        <div
                            ...
                            <div class="absolute bottom-0 text-white px-5 pb-6 z-10">
                                <a href=""
                                   class="block font-medium text-base">{{ $about->title ?? '' }}</a>
                                <span
                                    class="text-white/90 text-xs mt-3">{{ $about->description ?? '' }}</span>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <a href="javascript:;" data-tw-toggle="modal"
                           data-tw-target="#static-backdrop-modal-preview-{{ $about->id }}"
                        ...
                        <!-- BEGIN: Modal Content -->
                        <div id="static-backdrop-modal-preview-{{ $about->id }}" class="modal"
                             data-tw-backdrop="static" tabindex="-1"
                             aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body px-5 py-10">
                                        <form action="{{route('admin.about.edit',$about->id)}}" method="post"
                                            ...
                                            <div class="flex items-center justify-center w-full">
                                                <label class="flex flex-col w-full h-56 border-4 border-dashed dropzone"
                                                    ...
                                                    <div class="flex flex-col items-center justify-center pt-7">
                                                        <img src="{{asset('storage/'.$about->image)}}" alt="" id="preview" class="w-60 h-40 text-gray-400 group-hover:text-gray-600">
                                                    </div>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <input id="title" type="text" name="title" class="form-control" placeholder="Product Title" value="{{ old('title', $about->title) }}" required>
                                            </div>
                                            <div class="intro-y col-span-12 sm:col-span-6 mt-3">
                                                ...
                                                <textarea id="description" class="form-control" name="description" placeholder="Type your comments" minlength="5">{{$about->description}}</textarea>
                                            </div>
                        ...
                        <!-- BEGIN: Modal Toggle -->
                        <a href="javascript:;" data-tw-toggle="modal"
                           data-tw-target="#delete-modal-preview-{{$about->id}}"
                           class="flex items-center mr-auto text-danger">
                            <i data-lucide="trash-2" class="px-1 text-danger"></i>
                            Delete</a>
                        <!-- END: Modal Toggle -->
                        <!-- BEGIN: Modal Content -->
                        <div id="delete-modal-preview-{{$about->id}}" class="modal" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body p-0">
                                        ...
                                        <div class="px-5 pb-8 text-center">
                                            <form action="{{ route('admin.about.delete', $about->id) }}"
                                                  method="post">
