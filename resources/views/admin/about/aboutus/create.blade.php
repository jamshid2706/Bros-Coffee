<!-- BEGIN: Modal Toggle -->
<a href="javascript:;" data-tw-toggle="modal" data-tw-target="#header-footer-modal-preview" class="intro-y btn btn-primary my-5">Add About</a>
<!-- END: Modal Toggle -->
<!-- BEGIN: Modal Content -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h2 class="font-medium text-base mr-auto">Add About</h2>
            </div>
            <!-- END: Modal Header -->
            <!-- BEGIN: Modal Body -->
