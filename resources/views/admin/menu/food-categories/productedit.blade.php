            ...
            <div class="modal-body px-5 py-10">
                <form action="{{route('admin.products.edit',$product->id)}}" method="post"
                    ...
                    <div class="mt-3">
                        ...
                        <input id="title" type="text" name="title" class="form-control" placeholder="Product Title" value="{{ old('title', $product->title) }}" required>
                    </div>
                    <div class="mt-3">
                        <label for="vertical-form-2" class="form-label">Buy</label>
                        <input id="vertical-form-2" type="number" name="buy" class="form-control" value="{{ old('buy', $product->buy) }}" placeholder="Buy" required>
                    </div>
                    <div class="mt-3">
                        <label for="vertical-form-3" class="form-label">Sell</label>
                        <input id="vertical-form-3" name="sell" type="number" class="form-control" placeholder="Sell" value="{{ old('sell', $product->sell) }}" required>
                    </div>
                    <div class="mt-3">
                        <label for="vertical-form-4" class="form-label">Stock</label>
                        <input id="vertical-form-4" type="number" name="stock" class="form-control" placeholder="Stock" value="{{ old('stock', $product->stock) }}" required>
                    </div>
