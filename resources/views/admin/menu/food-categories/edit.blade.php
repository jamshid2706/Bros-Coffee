<!-- START: Modal Toggle -->
<a href="javascript:;" data-tw-toggle="modal" data-tw-target="#static-backdrop-modal-preview-{{$category->id}}" class="">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body px-5 py-10">
                <div class="text-left">
                    <form action="{{ route('admin.menu.food-categories.edit',$category->id) }}" method="post">
                        @csrf
                        <label for="vertical-form-1" class="form-label">Category Name</label>
                        <input id="vertical-form-1" type="text" class="form-control" name="title" value="{{old('category',$category->title)}}" placeholder="Category Name" required>
